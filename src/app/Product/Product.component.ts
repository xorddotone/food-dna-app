...
export class ProductComponent implements OnInit {
  ...
  foodDna = new FormControl('', Validators.required);
  ...
  updateAsset(form: any): Promise<any> {
    ...
    return this.serviceProduct.updateAsset(form.get('referenceNumber').value, this.asset)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.referenceNumber) {
        formObject.referenceNumber = result.referenceNumber;
      } else {
        formObject.referenceNumber = null;
      }
      ...
      if (result.foodDna) {
        formObject.foodDna = result.foodDna;
      } else {
        formObject.foodDna = null;
      }
